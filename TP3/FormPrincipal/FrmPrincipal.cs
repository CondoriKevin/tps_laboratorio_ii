...
namespace FormPrincipal
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void FiltrarDataGrid(DataGridView dataGridView, EMaquina proceso)
        {
            listaFiltro = stock.FiltrarLista(stock.ListaDeTelas, proceso);
        ...
        private void dtgvView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
